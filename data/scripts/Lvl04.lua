...
function SetActivatedRooms()
  ...
  for _, beaconEnt in pairs(Script.GetAllEnts()) do
    if beaconEnt.Name == "Beacon" then
      ...
      if pointIsInSpawns(beaconEnt.Pos, "Room1") then
        store.Room1 = true
      end
      if pointIsInSpawns(beaconEnt.Pos, "Room2") then
        store.Room2 = true
      end      
      if pointIsInSpawns(beaconEnt.Pos, "Room3") then
        store.Room3 = true
      end
      if pointIsInSpawns(beaconEnt.Pos, "Room4") then
        store.Room4 = true
      end
      if pointIsInSpawns(beaconEnt.Pos, "Room5") then
        store.Room5 = true
      end   
    end
  end
...
function RoundEnd(intruders, round)
  ...
  if store.side == "Humans" then
    ...
    if intruders then
      Script.DialogBox("ui/dialog/Lvl04/pass_to_denizens.json")
...
-- function IntruderWithBeaconsAlive()
--   if store.BeaconEnt.HpCur > 0 then
--     return true
--   end
--   return false  
-- end
